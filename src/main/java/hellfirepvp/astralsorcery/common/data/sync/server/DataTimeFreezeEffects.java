...
public class DataTimeFreezeEffects extends AbstractData {
    ...
    private final Map<net.minecraft.resources.ResourceKey<Level>, List<TimeStopEffectHelper>> serverActiveFreezeZones = new HashMap<>();
    ...
    public void addNewEffect(net.minecraft.resources.ResourceKey<Level> dim, TimeStopEffectHelper effectHelper) {
    ...
    public void removeEffect(net.minecraft.resources.ResourceKey<Level> dim, TimeStopEffectHelper effectHelper) {
    ...
    public void writeAllDataToPacket(CompoundTag compound) {
        ...
        for (net.minecraft.resources.ResourceKey<Level> dim : this.serverActiveFreezeZones.keySet()) {
    ...
    public static class ServerSyncAction {
        ...
        private ServerSyncAction(ActionType type, net.minecraft.resources.ResourceKey<Level> dim, TimeStopEffectHelper involvedEffect) {
            this.type = type;
            this.dim = dim;
        ...
        public net.minecraft.resources.ResourceKey<Level> getDimKey() {
            return dim;
        }
