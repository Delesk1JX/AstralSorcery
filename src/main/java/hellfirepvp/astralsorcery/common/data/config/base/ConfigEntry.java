 ...
 */
public abstract class ConfigEntry implements Consumer<NeoForgeConfigSpec.Builder> {
    ...
    @Override
    public final void accept(NeoForgeConfigSpec.Builder builder) {
    ...
    public abstract void createEntries(NeoForgeConfigSpec.Builder cfgBuilder);
