...
public class RegistryCapabilities {
    ...
    private static <T extends TagSerializable<CompoundTag>> net.neoforged.neoforge.capabilities.IStorage<T> serializeableStorage() {
        return new net.neoforged.neoforge.capabilities.IStorage<T>() {
            @Nullable
            @Override
            public Tag writeNBT(net.neoforged.neoforge.capabilities.Capability<T> capability, T instance, Direction side) {
                return instance.serializeNBT();
            }

            @Override
            public void readNBT(net.neoforged.neoforge.capabilities.Capability<T> capability, T instance, Direction side, Tag nbt) {
