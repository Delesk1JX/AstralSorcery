...
import net.neoforged.neoforge.common.capabilities.net.neoforged.neoforge.capabilitiesInject;
...
public class CapabilitiesAS {
    ...
    public static net.neoforged.neoforge.capabilities.Capability<ChunkFluidEntry> CHUNK_FLUID = null;
