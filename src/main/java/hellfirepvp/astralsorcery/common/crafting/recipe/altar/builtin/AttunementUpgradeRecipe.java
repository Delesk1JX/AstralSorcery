...
public class AttunementUpgradeRecipe extends SimpleAltarRecipe {
    ...
    public void onRecipeCompletion(TileAltar altar, ActiveSimpleAltarRecipe activeRecipe) {
        ...
        altar.getWorld().setBlockState(altar.getPos(), BlocksAS.ALTAR_ATTUNEMENT.getDefaultState(), net.neoforged.neoforge.common.util.FakePlayerFactory.BlockFlags.DEFAULT);
    }
}
