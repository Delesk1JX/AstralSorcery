...
public abstract class TemplateStructure extends TemplateStructurePiece {
    ...
    @Override
    public boolean func_230383_a_(ServerLevel world, StructureManager mgr, ChunkGenerator gen, Random rand, MutableBoundingBox box, ChunkPos chunkPos, BlockPos structCenter) {
