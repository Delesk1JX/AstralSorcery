 ...
 */
public class PerkAttributeType extends DeferredHolder<net.neoforged.neoforge.registries.RegistryKey<PerkAttributeType>, PerkAttributeType> implements ReadWriteLockable {
