...
public class FluidContainerDispenseBehavior extends DefaultDispenseItemBehavior {
    ...
    @Override
    protected ItemStack dispenseStack(net.minecraft.core.dispenser.BlockSource source, ItemStack stack) {
    ...
    @Nonnull
    private ItemStack fillContainer(net.minecraft.core.dispenser.BlockSource source, ItemStack stack) {
    ...
    @Nonnull
    private ItemStack dumpContainer(net.minecraft.core.dispenser.BlockSource source, @Nonnull ItemStack stack) {
