...
public class WorldSeedCache {
    ...
    private static final Map<net.minecraft.resources.ResourceKey<Level>, Long> cacheSeedLookup = new HashMap<>();
    ...
    @OnlyIn(Dist.CLIENT)
    public static void updateSeedCache(net.minecraft.resources.ResourceKey<Level> dim, int session, long seed) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static Optional<Long> getSeedIfPresent(net.minecraft.resources.ResourceKey<Level> dim) {
        if (dim == null) {
