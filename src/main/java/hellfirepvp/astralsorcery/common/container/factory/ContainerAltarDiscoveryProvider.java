...
public class ContainerAltarDiscoveryProvider extends CustomContainerProvider<ContainerAltarDiscovery> {
    ...
    @Nonnull
    @Override
    public ContainerAltarDiscovery createMenu(int id, IInventory plInventory, Player player) {
        return new ContainerAltarDiscovery(ta, plInventory, id);
    }

    private static ContainerAltarDiscovery createFromPacket(int id, IInventory plInventory, FriendlyByteBuf data) {
    ...
    public static class Factory implements IContainerFactory<ContainerAltarDiscovery> {
        ...
        @Override
        public ContainerAltarDiscovery create(int windowId, IInventory inv, FriendlyByteBuf data) {
