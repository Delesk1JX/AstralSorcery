...
public class ContainerAltarAttunementProvider extends CustomContainerProvider<ContainerAltarAttunement> {
    ...
    @Nonnull
    @Override
    public ContainerAltarAttunement createMenu(int id, IInventory plInventory, Player player) {
        return new ContainerAltarAttunement(ta, plInventory, id);
    }

    private static ContainerAltarAttunement createFromPacket(int id, IInventory plInventory, PacketBuffer data) {
    ...
    public static class Factory implements IContainerFactory<ContainerAltarAttunement> {
        ...
        @Override
        public ContainerAltarAttunement create(int windowId, IInventory inv, PacketBuffer data) {
