...
public class ContainerAltarRadianceProvider extends CustomContainerProvider<ContainerAltarTrait> {
    ...
    private static ContainerAltarTrait createFromPacket(int id, IInventory plInventory, FriendlyByteBuf data) {
    ...
    public static class Factory implements IContainerFactory<ContainerAltarTrait> {
        ...
        @Override
        public ContainerAltarTrait create(int windowId, IInventory inv, FriendlyByteBuf data) {
