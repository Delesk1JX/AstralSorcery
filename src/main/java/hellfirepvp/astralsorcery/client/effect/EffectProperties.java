...
public class EffectProperties<T extends EntityVisualFX> {
    ...
    private net.minecraft.core.Vec3i position = net.minecraft.core.Vec3i.NULL_VECTOR;
    ...
    public <I extends EffectProperties<T>> I setPosition(@Nonnull net.minecraft.core.Vec3i position) {
    ...
    @Nonnull
    public net.minecraft.core.Vec3i getPosition() {
        return position;
    }
