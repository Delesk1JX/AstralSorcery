...
public enum Blending {
    ...
    public RenderType.TransparencyState asState() {
        return new RenderType.TransparencyState(AstralSorcery.key("blending_" + this.name().toLowerCase(Locale.ROOT)).toString(), () -> {
